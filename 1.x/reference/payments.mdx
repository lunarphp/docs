...
head over to the [extending section](/0.x/extending/payments).
</Tip>
...
You can find out more in the Extending Lunar section for [Orders](/1.x/extending/orders).
...
To add Shipping Options you will need to [extend Lunar](/1.x/extending/shipping) to add in your own logic.
...
In the meantime, you can absolutely still get a storefront working, at the end of the day Lunar doesn't really mind if what payment provider you use or plan to use.
