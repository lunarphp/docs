...
<Info>
1.5.0 is currently available as a beta release. Pin to `1.5.0-beta.6` (or later) in `composer.json` while testing the upgrade on a staging environment first. Projects that need to remain on Filament v3 should stay on the [1.4 release line](#14).
</Info>
...
Lunar 1.4 is the latest stable release and the final minor version built on Filament v3. Lunar 1.5, currently in beta, upgrades the admin panel to Filament v4. Projects that need to remain on Filament v3 should stay on the 1.4 release line.
