...
Although orders have access to the same customisation as [Pages](/1.x/admin/extending/pages) there are some additional methods available and an additional class to allow order lines to be customised.
