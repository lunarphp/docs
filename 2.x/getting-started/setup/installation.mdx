...
- Filament 4 (Lunar 1.5+) — Filament 3 is supported on Lunar 1.4 and earlier
...
<Info>
Lunar 1.5 builds the admin panel on Filament v4. Projects that need to stay on Filament v3 should install the 1.4 release line, which is the final Lunar version to support it: `composer require lunarphp/lunar:"^1.4"`. See the [upgrade guide](/1.x/getting-started/overview/upgrade-guide#15) for the differences between the two.
</Info>
