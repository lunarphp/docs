...
| `decimal_places` | `integer` | The number of decimal places, e.g. `2`. See [Pricing](/2.x/reference/pricing#decimal-value) for how this affects stored prices |
...
|:-|:-|:-|:-|
| `prices` | `HasMany` | `Lunar\Core\Models\Price` | Prices in this currency |
