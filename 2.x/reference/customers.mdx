...
```php
Lunar\Core\Models\Customer::create([
    'title' => 'Mr.',
    'first_name' => 'Tony',
    'last_name' => 'Stark',
...
```php
$customer = Lunar\Core\Models\Customer::create([
    'title' => 'Mr.',
    'first_name' => 'Tony',
    'last_name' => 'Stark',
]);
...
|:-|:-|:-|:-|
|`customerGroups`|`BelongsToMany`|`Lunar\Core\Models\CustomerGroup`|Pivot: `customer_customer_group`|
|`users`|`BelongsToMany`|Configured via `auth.providers.users.model`|Pivot: `customer_user`|
|`discounts`|`BelongsToMany`|`Lunar\Core\Models\Discount`|Pivot: `customer_discount`|
|`addresses`|`HasMany`|`Lunar\Core\Models\Address`||
|`orders`|`HasMany`|`Lunar\Core\Models\Order`||
|`carts`|`HasMany`|`Lunar\Core\Models\Cart`||
|`mappedAttributes`|`MorphToMany`|`Lunar\Core\Models\Attribute`||
...
```php
$customerGroup = Lunar\Core\Models\CustomerGroup::create([
    'name' => 'Retail',
...
class MyModel extends Model
{
    ...
    public function customerGroups(): BelongsToMany
    {
        ...
        return $this->belongsToMany(
            \Lunar\Core\Models\CustomerGroup::class,
