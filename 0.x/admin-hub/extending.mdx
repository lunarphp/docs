...
If you have [registered your own discount types](/0.x/extending/discounts) in the core, you will likely want to provide an interface so authenticated staff members can add the data required.

<Warning>
You need to make sure you have [registered your discount](/0.x/extending/discounts) with the Lunar core beforehand.
</Warning>
