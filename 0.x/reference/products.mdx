...
Product Types also have [Attributes](/0.x/reference/attributes) associated to them. These associated attributes will
...
For the full reference on how to format prices for your storefront see the [Pricing Reference](/0.x/reference/pricing)
...
![](/0.x/images/products/dr-martens.png)
