...
<Tip>All values will return a `Lunar\Datatypes\Price` object. So you have access to the following: `value`, `formatted`, `decimal`</Tip>
...
[Cart Extending](/0.x/extending/carts).
