...
If you would prefer to install Lunar into your own Laravel application, please follow the [installation instructions](/0.x/getting-started/setup/installation).
