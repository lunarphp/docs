...
```sh
composer require lunarphp/lunar:"^0.8" -W
```
...
### Table Prefix
Lunar uses table prefixes to avoid conflicts with your app's tables. You can change this in the [configuration](/0.x/getting-started/setup/configuration).
